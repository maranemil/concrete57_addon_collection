...
<form method="post" id="package_starting_point_form" action="<?php echo $this->action('update') ?>">
    ...
    <div class="ccm-dashboard-content-full">
        ...
        <table style="width:100%;" class="ccm-search-results-table">
            <thead>
            <tr>
            ...
            foreach ($settings as $setting) {
                ...
                <tr>
                    ...
                    <td><label>
                            <input type="text" class="form-control" value="<?php echo $setting['value']; ?>"
                                       name="<?php echo $setting['handle']; ?>">
                        </label>
                </tr>
                <?php
            }
    ...
    <div class="ccm-dashboard-form-actions-wrapper">
        <div class="ccm-dashboard-form-actions">
            ...
            <button class="pull-left btn" type="button"
                    onclick="location.href = '<?php echo $url->to('/dashboard'); ?>';"><?php echo t('Go to the Dashboard') ?></button>
        </div>
    </div>
</form>