...
class Controller extends BlockController
{
    ...
    public function action_getEntryHTML()
    {
        if (!isset($_REQUEST['tumblrUsername'], $_REQUEST['tumblrEntryID'])) {
            exit;
        }
        ...
        while (!$contents) {
            ...
            $contents = Loader::helper('file')->getContents('https://' . $tumblrUsername . '.tumblr.com/api/read/json?id=' . $entryToDisplay);
